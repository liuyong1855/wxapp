Page({
	...
	movemark:function(e){
		this.mapContext.translateMarker({
			markerId:0,
			destination:{
				longitude:116.39080865479,
				latitude:39.8000492658
			},
			rotate:90,
			autoRotate:true,
			duration:300,
			animationEnd:function(d){
				console.log(d)
			}
		})
	},
	scfw:function(e){
		this.mapContext.includePoints({
			points:[{
				...
				longitude:114.39080865479,
				latitude:39.8000492658
			},{
				longitude:116.39080865479,
				latitude:34.8000492658
			},{
				longitude:112.39080865479,
				latitude:35.8000492658
			}]
		})
	},
	region:function(e){
